...
#define TAS2555_DAC_GAIN_SHIFT			0x03
...
struct tas2555_priv {
	...
	int (*read)(struct tas2555_priv *pTAS2555,
		enum channel chn,
		unsigned int reg,
		unsigned int *pValue);
	int (*write)(struct tas2555_priv *pTAS2555,
		enum channel chn,
		unsigned int reg,
		unsigned int Value);
	int (*bulk_read)(struct tas2555_priv *pTAS2555,
		enum channel chn,
		unsigned int reg,
		unsigned char *pData,
		unsigned int len);
	int (*bulk_write)(struct tas2555_priv *pTAS2555,
		enum channel chn,
		unsigned int reg,
		unsigned char *pData,
		unsigned int len);
	int (*update_bits)(struct tas2555_priv *pTAS2555,
		enum channel chn,
		unsigned int reg,
		unsigned int mask,
		unsigned int value);
	int (*set_config)(struct tas2555_priv *pTAS2555,
		int config);
	int (*set_calibration)(struct tas2555_priv *pTAS2555,
		int calibration);
