...
#define BFM_MTK_WAIT_FOR_LOG_PART_TIMEOUT 40
...
int bfm_platform_process_boot_fail(bfm_process_bootfail_param_t *param)
{
    ...
    if (0 != bfmr_wait_for_part_mount_with_timeout(bfm_get_bfmr_log_part_mount_point(), BFM_MTK_WAIT_FOR_LOG_PART_TIMEOUT))
    {
        BFMR_PRINT_ERR("log part [%s] is not ready\n", BFM_QCOM_LOG_PART_MOUINT_POINT);
