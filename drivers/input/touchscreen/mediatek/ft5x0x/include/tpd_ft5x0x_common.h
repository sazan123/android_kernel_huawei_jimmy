...
#define TPD_CALIBRATION_MATRIX_ROTATION_NORMAL  {-4096, 0, 720*4096, 0, -4096, 1280*4096, 0, 0}
#define TPD_CALIBRATION_MATRIX_ROTATION_FACTORY {-4096, 0, 720*4096, 0, -4096, 1280*4096, 0, 0}
...
extern void tpd_ft5x0x_reset(void);
