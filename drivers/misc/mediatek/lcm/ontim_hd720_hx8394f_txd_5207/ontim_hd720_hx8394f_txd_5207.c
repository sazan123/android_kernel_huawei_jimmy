...
static struct LCM_setting_table init_setting[] = {
	...
	{0xB1,10,{0x48,0x10,0x70,0x09,0x33,0x54,0x71,0x71,0x57,0x43}},
	{0xB2,06,{0x00,0x80,0x64,0x0C,0x0D,0x2F}},
	{0xB4,23,{0x70,0x71,0x70,0x71,0x70,0x71,0x0C,0x0C,0x84,0x45,0x00,0x3F,0x70,0x71,0x70,0x71,0x70,0x71,0x0C,0x0C,0x84,0x03,0x00}},
	//{0xB6,02,{0x62,0x62}},
	{0xD3,33,{0x00,0x00,0x07,0x07,0x40,0x07,0x0C,0x00,0x08,0x10,0x08,0x00,0x08,0x54,0x15,0x0A,0x05,0x0A,0x02,0x15,0x06,0x05,0x06,0x47,0x44,0x0A,0x0A,0x4B,0x10,0x07,0x07,0x0C,0x40}},
	...
	{0xD6,44,{0x1A,0x1A,0x1B,0x1B,0x07,0x06,0x05,0x04,0x03,0x02,0x01,0x00,0x0B,0x0A,0x09,0x08,0x21,0x20,0x18,0x18,0x27,0x26,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x25,0x24,0x18,0x18,0x18,0x18}},
	{0xE0,58,{0x00,0x01,0x0A,0x0E,0x0D,0x15,0x18,0x16,0x31,0x40,0x4F,0x4F,0x58,0x6A,0x70,0x74,0x81,0x83,0x7F,0x8D,0x9E,0x4D,0x4D,0x4F,0x57,0x5B,0x61,0x7C,0x7F,0x0E,0x12,0x17,0x1B,0x1B,0x1F,0x24,0x20,0x3F,0x4E,0x61,0x5F,0x6A,0x7A,0x81,0x87,0x93,0x98,0x94,0xA4,0xB5,0x5B,0x59,0x5E,0x5F,0x63,0x6C,0x7E,0x7F}},
	{0xC0,02,{0x1F,0x31}},
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.vertical_frontporch = 8; //OLD IS 15
	...
	params->dsi.PLL_CLOCK = 204;    /*OLD IS 204 this value must be in MTK suggested table */
...
static void lcm_init(void)
{
	...
	if (ret < 0)
		LCM_LOGI("txd_hx8394f----nt50358a----cmd=%0x--i2c write error----\n", cmd);
	else
		LCM_LOGI("txd_hx8394f----nt50358a----cmd=%0x--i2c write success----\n", cmd);
...
#define LCM_ID_TXD_HX8394F (0x8394)
...
static unsigned int lcm_compare_id(void)
{
	...
	LCM_LOGI("%s,txd_hx8394f debug: txd_hx8394f id = 0x%08x\n", __func__, id);

	if (id == LCM_ID_TXD_HX8394F)
		return 1;
	else
		return 0;
}
...
static void lcm_setbacklight(void *handle, unsigned int level)
{
	...
	printk(KERN_ERR "%s,txd_hx8394f_5207 backlight: level = %d\n", __func__, level);
...
static void  set_lcdkit_info(void)
{
           ...
           lcdkit_info.panel_infos.model_name = "TXD_HX8394F_5207 5.5' VIDEO TFT 720x1280";
...
LCM_DRIVER ontim_hd720_hx8394_txd_5207_lcm_drv = {
	.name = "txd_hx8394f_5207_hd720",
