...
static struct LCM_setting_table init_setting[] = {
	...
	{0xB1,10,{0x48,0x12,0x72,0x09,0x33,0x54,0x71,0x71,0x57,0x43}},
	{0xB2,06,{0x00,0x80,0x64,0x0C,0x0D,0x2F}},
	{0xB4,23,{0x70,0x7C,0x70,0x7C,0x70,0x7C,0x0C,0x0C,0x86,0x75,0x00,0x3F,0x70,0x71,0x70,0x71,0x70,0x71,0x0C,0x0C,0x84,0x03,0x00}},
	//{0xB6,02,{0x62,0x62}},
	...
	{0xE0,58,{0x00,0x06,0x0F,0x15,0x18,0x1C,0x1F,0x1E,0x3E,0x4E,0x5E,0x5D,0x67,0x7A,0x80,0x84,0x93,0x96,0x93,0xA2,0xB5,0x5A,0x59,0x5E,0x62,0x65,0x6A,0x6D,0x6C,0x00,0x06,0x0F,0x15,0x18,0x1C,0x1F,0x1E,0x3E,0x4E,0x5E,0x5D,0x67,0x7A,0x80,0x84,0x93,0x96,0x93,0xA2,0xB5,0x5A,0x59,0x5E,0x62,0x65,0x6A,0x6D,0x6C}},
	{0xC0,02,{0x1F,0x31}},
...
static void lcm_setbacklight(void *handle, unsigned int level)
{
	...
	printk(KERN_ERR "%s,txd_hx8394f backlight: level = %d\n", __func__, level);
...
static void  set_lcdkit_info(void)
{
           ...
           lcdkit_info.panel_infos.model_name = "TXD_HX8394F 5.5' VIDEO TFT 720x1280";
...
LCM_DRIVER ontim_hd720_hx8394_txd_lcm_drv = {
	.name = "txd_hx8394f_hd720",
