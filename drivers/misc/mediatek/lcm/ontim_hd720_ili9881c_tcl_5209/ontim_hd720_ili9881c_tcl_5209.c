...
static struct LCM_setting_table init_setting[] = {
	...
	{0x6C,1,{0x15}},//Vcore
	{0x6E,1,{0x2A}},//Adjust VGH 2017.06.
	{0x6F,1,{0x35}},//VGH=3VSP VGL=-3VSP
	{0x3A,1,{0x24}},//Source OP
	{0x8D,1,{0x1F}},//VGL clamp -12.03V
	{0x87,1,{0xBA}},//LVD=Mediun
	{0x26,1,{0x76}},//SD Timing Setting
	{0xB2,1,{0xD1}},//Gamma Reload Enable
	{0x69,1,{0x57}},//VCL clamp level=2.9
	{0x33,1,{0x44}},//Source Level
	{0x88,1,{0x0B}},//LVD check function
	{0x35,1,{0x1F}},//Source Timing setti
	{0xB5,1,{0x07}},//Gamma Bias Level=Hi
	{0x7A,1,{0x0F}},//ADD 2017.06.12
	{0xFF,3,{0x98,0x81,0x01}},//CMD_Page
	{0x22,1,{0x0A}},//BGR, SS
	{0x31,1,{0x00}},//column inversion
	{0x50,1,{0x7A}},//VREG1OUT=4.176V
	{0x51,1,{0x7A}},//VREG2OUT=-4.176V
	{0x60,1,{0x14}},//SDT
	{0x63,1,{0x00}},//ADD 2017.06.12
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.vertical_backporch = 8; //old is 8,now is 100
...
static void lcm_init(void)
{
	...
	if (ret < 0)
		LCM_LOGI("auo----illi9881c----cmd=%0x--i2c write error----\n", cmd);
	else
		LCM_LOGI("auo----illi9881c----cmd=%0x--i2c write success----\n", cmd);
...
static void  set_lcdkit_info(void)
{
           ...
           lcdkit_info.panel_infos.model_name = "TCL_5209_ILI9881C 5.5' VIDEO TFT 720x1280";
...
LCM_DRIVER ontim_hd720_ili9881c_tcl_5209_lcm_drv = {
	.name = "tcl_ili9881c_hd720_5209",
