...
wlanoidSetConnect(IN P_ADAPTER_T prAdapter, IN PVOID pvSetBuffer, IN UINT_32 u4SetBufferLen, OUT PUINT_32 pu4SetInfoLen)
{
	...
	printk("wlanoidSetConnect pParamConn->u4SsidLen=%d",pParamConn->u4SsidLen);
	...
	printk("wlanoidSetConnect prConnSettings->fgIsConnReqIssued=%d",prConnSettings->fgIsConnReqIssued);
