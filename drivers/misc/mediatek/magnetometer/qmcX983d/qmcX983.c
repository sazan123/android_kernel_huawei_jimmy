...
static char mc3410_prox_version[]="qmc7983_mtk_1.0";
static char mc3410_prox_vendor_name[20]="QST-QMC7983";
...
static ssize_t store_WRregisters_value(struct device_driver *ddri, const char *buf, size_t count)
{
	...
	sscanf(buf,"0x%x",(unsigned int*)&tempbuf[0]);
	
	MSE_ERR("%s REG_VAL = x%2x \n",__func__,tempbuf[0]);
...
static ssize_t store_registers_value(struct device_driver *ddri, const char *buf, size_t count)
{
	...
	if(1 == sscanf(buf,"0x%x",(unsigned int*)&regbuf[0])){
