...
extern int disp_lcm_set_scanmode(disp_lcm_handle *plcm, void *handle, unsigned int enable);
int _set_scanmode_by_cmdq(unsigned int mode)
{
       int ret = 0;
       cmdqRecHandle cmdq_handle_scanmode = NULL;
...
extern int disp_lcm_set_inversionmode(disp_lcm_handle *plcm, void *handle, unsigned int enable);
int _set_inversionmode_by_cmdq(unsigned int mode)
{
       int ret = 0;
       cmdqRecHandle cmdq_handle_inversionmode = NULL;
