...
int disp_lcm_set_scanmode(disp_lcm_handle *plcm, void *handle, unsigned int mode)
{
       LCM_DRIVER *lcm_drv = NULL;
       DISPFUNC();
       if (_is_lcm_inited(plcm))
...
int disp_lcm_set_inversionmode(disp_lcm_handle *plcm, void *handle, unsigned int mode)
{
       LCM_DRIVER *lcm_drv = NULL;
       DISPFUNC();
       if (_is_lcm_inited(plcm))
